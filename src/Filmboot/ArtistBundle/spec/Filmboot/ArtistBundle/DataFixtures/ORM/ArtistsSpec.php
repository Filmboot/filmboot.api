...
namespace spec\Filmboot\ArtistBundle\DataFixtures\ORM;

use Doctrine\Common\Persistence\ObjectManager;
use Filmboot\ArtistBundle\Command\LoadArtistsCommand;
...
class ArtistsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Filmboot\ArtistBundle\DataFixtures\ORM\Artists');
    }
    ...
    )
    {
        ...
        $container->get('filmboot_artist.command_artists')

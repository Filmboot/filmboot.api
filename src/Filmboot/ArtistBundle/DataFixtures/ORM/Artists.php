...
namespace Filmboot\ArtistBundle\DataFixtures\ORM;
 ...
 * Class Artists.
 *
 * @package Filmboot\ArtistBundle\DataFixtures\ORM
 */
class Artists extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        $this->container->get('filmboot_artist.command_artists')->loadArtists(

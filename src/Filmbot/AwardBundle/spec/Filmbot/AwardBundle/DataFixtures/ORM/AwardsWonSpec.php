...
use Filmbot\AwardBundle\Command\LoadAwardsWonCommand;
...
class AwardsWonSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Filmbot\AwardBundle\DataFixtures\ORM\AwardsWon');
    }
    ...
    )
    {
        ...
        $container->get('filmbot_award.command_awardsWon')
